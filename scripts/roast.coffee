# Commands:
#   hubot roast @username - Shows a tastefully insult
...
module.exports = (robot) ->
  ...
  robot.respond /roast me/i, (res) ->
    res.reply res.random insults

  robot.respond /roast @([^\s]+)/i, (res) ->
    username = "#{res.match[1]}"

    if username.toLowerCase() is process.env.USERNAME.toLowerCase()
      res.reply res.random insults if res.match?
    else
      res.send "@#{username} #{res.random insults}" if res.match?
